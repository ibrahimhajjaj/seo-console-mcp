...
const writeTools = ["ads_negatives_update", "ads_update", "ads_update_batch", "delete_sitemap", "indexnow_submit", "request_recrawl", "submit_sitemap"];
...
const spendTools = ["ads_negatives_update", "ads_update", "ads_update_batch"];
